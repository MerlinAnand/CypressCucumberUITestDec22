...
Given("Customer navigates to the Magento Website SignIn Link and Login using {string} and {string}", function (userName, password) {
 ...
 When("Customer Selects a {string} and Navigates to the Product Details Page", function (product) {
 ...
 When("Customer Proceeds to the CheckOut Page and Click Next to Place an Order", function (product) {
